...
export default function AwardApp({ Component, pageProps }) {
  ...
  const NavItems = [
    ...
    },
    {
      ...
      href: "https://discord.gg/YDGpPRXZrt",
    },
    {
      link: true,
      name: "Botu Sunucuna Ekle",
      icon: "fal fa-robot",
      activeIcon: "fab fa-robot",
      href: "https://discord.com/oauth2/authorize?client_id=1183834629883576381&scope=bot%20applications.commands&permissions=0",
    },
       {
      link: true,
      name: "Botu Oyla",
